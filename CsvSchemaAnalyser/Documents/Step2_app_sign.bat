@ECHO OFF
COPY /Y "..\bin\Debug\publish\JocysCom.CsvSchemaAnalyser.exe" "JocysCom.CsvSchemaAnalyser.exe"
CALL:SIG "JocysCom.CsvSchemaAnalyser.exe"
echo.
pause
...
set d=Jocys.com CSV Schema Analyser
